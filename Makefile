...
.PHONY: all build clean doc convert client bundle npm-package npm-pack npm-publish check swag run help install-npm bundle-deps docker docker-login docker-build multi-arch-build dev helm-update
