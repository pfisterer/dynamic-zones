...
| `ZONE_PROVIDER_FIXED_DOMAIN_SUFFIXES` | `test.example.com, demo.example2.org` | Required if **Provider** is set to `fixed` | Comma-separated list of fixed domain suffixes for "fixed" provider (e.g., "example.com, example2.org") |
